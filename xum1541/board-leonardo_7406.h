/*
 * Board interface routines for the Leonardo (with 7406)
 ...
 */
#ifndef _BOARD_LEONARDO_7406_H
#define _BOARD_LEONARDO_7406_H
...
#define IO_DATA         _BV(0) // PF0 / A5
#define IO_CLK          _BV(1) // PF1 / A4
#define IO_ATN          _BV(4) // PF4 / A3
#define IO_SRQ          _BV(5) // PF5 / A2
#define IO_RESET        _BV(6) // PF6 / A1

// Input signals
#define IO_DATA_IN      _BV(4) // PD4 / 4
#define IO_CLK_IN       _BV(6) // PD6 / 12
#define IO_ATN_IN       _BV(7) // PD7 / 6
#define IO_SRQ_IN       _BV(6) // PC6 / 5
#define IO_RESET_IN     _BV(7) // PC7 / 13

#define IEC_F_MASK		0x73   /* port F pins 0, 1, 4, 5 and 6 as outputs */
#define IEC_F_PORT		PORTF
#define IEC_F_DDR		DDRF
#define IEC_F_PIN		PINF
...
// Pins: 3, 2, RXI, TXO, 8, 9, 10, 11 make a Parallel Port
// in that order, coressponding to D0 - D7

#define PAR_PORT0_MASK   0x0f   /* port D pins 0-3 */
#define PAR_PORT0_DDR    DDRD
#define PAR_PORT0_PIN    PIND
#define PAR_PORT0_PORT   PORTD

#define PAR_PORT1_MASK   0xf0   /* port B pins 4-7 */
